      ...
      <Card>
        ...
        <TableContainer component={Paper}>
          <Table sx={{ minWidth: 650 }} aria-label="simple table">
            <TableHead
              className="bg-gray-400 text-slate-100 font-bold"
              sx={{ fontSize: "1.25rem" }}
            >
              <TableRow>
                ...
                >
                  ...
                  <TableCell>
                    <div>
                      ...
                      >
                        <MenuItem
                          onClick={() => handlePlaceOrder(item.id, index)}
                        >
                          Placed
                        </MenuItem>
                        <MenuItem
                          onClick={() => handleShipOrder(item.id, index)}
                        >
                          Shipped
                        </MenuItem>
                        <MenuItem
                        ...
                        <MenuItem
                          onClick={() => handleCancelOrder(item.id, index)}
                        >
                          Cancelled
                        </MenuItem>
                        <MenuItem
                          onClick={() => handleConfirmOrder(item.id, index)}
                        >
                          Confirmed
                        </MenuItem>
                      </Menu>
