      ...
      <Grid container spacing={2} className='p-4'>
        ...
        
        {
          productData.size.map((size,index)=>(
            <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} className=' w-full' key={index}> 
                <Grid item size={6}>
                  <TextField 
                  label="Size Name"              
                  name='name'
            ...
            <Grid item size={{xs:12}}>
              <Button onClick={handleClick} variant='contained' type='submit' className='py-20' sx={{p:2}} size='large'>
                Add New Product
              </Button>
            </Grid>
