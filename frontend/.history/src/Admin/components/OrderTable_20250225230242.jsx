...
const OrderTable = () => {
    ...
    const handlePlaceOrder = (orderId,index) => { 
  ...
  return (
    ...
    <Card>
      ...
      >
        <MenuItem onClick={()=>handlePlaceOrder(item.id ,index)}>Placed</MenuItem>
        <MenuItem onClick={()=>handleShipOrder(item.id,index)}>Shipped</MenuItem>
        <MenuItem onClick={()=>handleDeliveredOrder(item.id,index)}>Delivered</MenuItem>
        <MenuItem onClick={()=>handleCancelOrder(item.id,index)}>Cancelled</MenuItem>
        <MenuItem onClick={()=>handleConfirmOrder(item.id,index)}>Confirmed</MenuItem>
