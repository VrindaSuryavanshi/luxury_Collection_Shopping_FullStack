  ...
  return (
    <div>
       <Card  sx={{
        ...
        <CardHeader title='Monthly Overview' sx={{display: 'flex', alignItems: 'left'}}
        action={
        ...
        subheader={
            <Typography variant='body2'>
                <Box component='span'
                 sx={{fontWeight: 600 , mx:1.5, color: '#66bb6a',fontWeight:700,paddingBottom:"5px", display: 'flex', alignItems: 'left'}}>
