...
const ProductCard = ({product}) => {
  ...
  return (
    <div onClick={()=>navigate(`/productdetails`)} className='productCard w-[15rem] m-3 transition-all cursor-pointer '>
      ...
      <div className='textPart bg-white p-3'>
        <div>
            <p className='brand font-bold opacity-60'>{product.category}</p>
