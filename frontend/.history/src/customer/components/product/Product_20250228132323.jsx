  ...
  useEffect(() => {
      const [minPrice, maxPrice] =
        ...
        [0,10000]
         ...
         console.log(" product data inside product jsx ",data);
        ...
        <main className="mx-auto  px-4 sm:px-6 lg:px-20">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            ...
            <div className="flex items-center">
              ...
              >
                <span className="sr-only text-red-600">Filters</span>
                        ...
                        <div className="space-y-4">
                          {section.options.map((option, optionIdx) => (
                            ...
                            >
                              <input
                                onChange={() =>
                                  HandleMultipleFilter(option.value, section.id)
                                }
                                defaultValue={option.value}
                                defaultChecked={option.checked}
                        ...
                        <div className="space-y-4">
                          {section.options.map((option, optionIdx) => (
                            ...
                            >
                              <input
                                onChange={(e) =>
                                  handleSingleFilter(section.id, e)
                                }
                                defaultValue={option.value}
                                defaultChecked={option.checked}
                                id={`filter-${section.id}-${optionIdx}`}
          ...
          <section className='w-full px=[3.4rem]'>
