  ...
  return (
    <div className="px-5 lg:px-20">
      ...
      <Grid2 className="space-y-5  mt-4" container sx={{ bgcolor:"yellow"}}>
        <Grid2 item container spacing={4} className='shadow-lg rounded-md p-5 border w-full'
        sx={{ alignItems:'center' , justifyContent:'space-between' ,bgcolor:"blue"}}>

            <Grid2 item size={{xs:6}} sx={{ bgcolor:"red"}}>
            ...
            <Grid2 item size={{xs:6}} sx={{ bgcolor:"green"}}>
