...
const OrderCard = () => {
  ...
  let description = ` Light Lilla Ballgown - Luxury Dress - Dress Sparkly - Lilla
      ...
      <Grid2 container spacing={2} sx={{ justifyContent: "space-between" , flexDirection: { xs: 'column', md: 'row' }}}>
        ...
        <Grid2 item size={{ xs: 6 }} >
          <div className="flex cursor-pointer">
            ...
            <div className="ml-5 space-y-2 md:flex sm:flex-row sm:max-w-full">
              <p className="text-sm  bg-slate-400">
                <pre>
               {description}
                </pre>
