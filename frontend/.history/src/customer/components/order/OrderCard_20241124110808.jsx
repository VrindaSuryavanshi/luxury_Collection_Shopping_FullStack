...
const OrderCard = () => {
  ...
  Dress-Dress Sparkly-Lilla 
  Wedding Dress-Evening 
  Dress-Prom 
  Dress-Wedding Dress`;
  return (
    <div onClick={()=>navigate(`/account/order/${9}`)} className="p-5 shadow-md hover:shadow-2xl border ">
      <Grid2 container spacing={2} sx={{ justifyContent: "space-between" ,justifyItems:{xs:'center'} , flexDirection: { xs: 'column', md: 'row' }}}>
        ...
        <Grid2 item size={{ xs: 4 }} >
          <div className="flex cursor-pointer">
            ...
            <div className="ml-5 space-y-2 sm:flex sm:flex-row ">
              <p className="text-sm">
                <pre className="description flex flex-wrap text-left">
               {description}
                </pre>
