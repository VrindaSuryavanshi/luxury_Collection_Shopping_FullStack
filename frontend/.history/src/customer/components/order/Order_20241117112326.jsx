...
const Order = () => {
  return (
    <div className="m-4">
      <Grid2 container sx={{ justifyContent: "space-between" , flexDirection: { xs: 'column', sm: 'row' } }} >
     ...
     border-gray-300 text-indigo-600 focus:ring-indigo-500"
        ...
        <Grid2 item size={{xs :9.5}}>
        <div className="h-auto shadow-lg bg-white p-5  top-5 text-left">
