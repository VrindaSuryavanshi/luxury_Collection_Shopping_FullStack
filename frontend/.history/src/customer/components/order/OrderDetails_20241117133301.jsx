...
const OrderDetails = () => {
  return (
    <div className="px-5 lg:px-20">
      ...
      <Grid2 className="space-y-5  mt-4" container sx={{ bgcolor:"yellow"}}>
        <Grid2 item container spacing={4} className='shadow-lg rounded-md p-5 border flex justify-between w-full'
        sx={{justifyItems:"center" , bgcolor:"blue"}}>

            <Grid2 item size={{xs:4}} sx={{ bgcolor:"red"}}>
            ...
            <Grid2 item size={{xs:8}} sx={{ bgcolor:"green", justifyItems:"end"}}>
