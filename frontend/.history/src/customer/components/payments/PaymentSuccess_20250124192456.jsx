                    ...
                    return (
                        <Grid2 item xs={6} >
                            <div className='flex  items-center'>
                                <img className='w-[5rem] h-[5rem] object-cover object-top' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTXZKow6hgcxQRMNYsmQykSgeHtis9wSVPYRg&s' alt='' className='w-24 h-24' />
                                </div>
                            ...
                            <Grid2 item>                       <AddressCard address={' '} />
                        </Grid2>
                        </Grid2>
