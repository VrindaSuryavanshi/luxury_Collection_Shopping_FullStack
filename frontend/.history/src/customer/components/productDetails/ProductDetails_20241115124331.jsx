              ...
              <Grid2 item xs={5}>
                ...
                {/* <Grid2 container gap={2}>
                  ...
                  >
                    ...
                    <div className=" flex justify-center  flex-row items-center space-x-6">
                      <p className="w-32">Very Good</p>
                      <BorderLinearProgress
                        variant="determinate"
                        value={30}
                        color="success"
...
<Grid2 item xs={12} md={6}>
        ...
        <Paper  style={{boxShadow:'none' , width:150 }}>
          {/* Nested Grid */}
          <Grid2 container spacing={2}>
            <Grid2 item xs={6}>
              <Paper style={{ boxShadow:'none' , width:150  , textAlign: 'center'}}>
              Excellent
              </Paper>
            </Grid2>
            <Grid2 item xs={6}>
              <Paper  style={{boxShadow:'none' , width:150  , textAlign: 'center' ,marginTop:10}}>
              <BorderLinearProgress
                        variant="determinate"
                        value={50}
                        color="success"
        ...
        <Paper  style={{boxShadow:'none'  }}>
          ...
          <Grid2 container spacing={2}>
            <Grid2 item xs={6}>
              <Paper style={{ boxShadow:'none' , width:150  , width:150 , textAlign: 'center' }}>
              Poor
              </Paper>
            </Grid2>
            <Grid2 item xs={6}>
              <Paper  style={{boxShadow:'none' , width:150  , textAlign: 'start' ,marginTop:10}}>
              <BorderLinearProgress
                        variant="determinate"
                        value={15}
                        color="warning"
