...
<p className="ml-3 text-sm font-medium text-indigo-600">456 Reviews</p>
                      ...
                      {product.sizes.map((size) => (
                        <Radio
                          ...
                          className={classNames(
                            ...
                            "group relative flex items-center justify-center rounded-md border px-2 py-2 text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none data-[focus]:ring-2 data-[focus]:ring-indigo-500 sm:flex-1 sm:py-6"
                          )}
                        >
                          <span>{size.name}</span>
                          {size.inStock ? (
              ...
              <Button variant="contained" sx={{px:"2rem", py:"1rem" , bgcolor:"#9155fd", mt:"5px"}}>
                        Add To Cart
              </Button>
