...
<Grid2 item xs={12} md={6}>
        ...
        <Paper  style={{boxShadow:'none'}}>
          ...
          <Grid2 container spacing={2}>
            <Grid2 item xs={6}>
              <Paper style={{ boxShadow:'none' , textAlign: 'start' }}>
              Excellent
              </Paper>
            </Grid2>
            <Grid2 item xs={6}>
              <Paper  style={{boxShadow:'none' , textAlign: 'start' ,marginTop:10}}>
              <BorderLinearProgress
                        variant="determinate"
                        value={50}
                        color="success"
        ...
        <Paper  style={{boxShadow:'none'}}>
          ...
          <Grid2 container spacing={2}>
            <Grid2 item xs={6} >
              <Paper style={{ boxShadow:'none' , alignContent: 'start',background:"yellow" }}>
              Poor
              </Paper>
            </Grid2>
            <Grid2 item xs={6}>
              <Paper  style={{boxShadow:'none' , textAlign: 'center' ,marginTop:10}}>
              <BorderLinearProgress
                        variant="determinate"
                        value={10}
                        color="error"
