                      ...
                      {product.sizes.map((size) => (
                        <Radio
                          ...
                          className={classNames(
                            ...
                            "group relative flex items-center justify-center rounded-md border  text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none data-[focus]:ring-2 data-[focus]:ring-indigo-500 sm:flex-1 sm:py-4"
                          )}
                        >
                          <span>{size.name}</span>
                          {size.inStock ? (
