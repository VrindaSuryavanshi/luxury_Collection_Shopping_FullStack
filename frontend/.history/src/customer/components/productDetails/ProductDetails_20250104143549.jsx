...
setProductData(data);
  ...
  const handleAddToCart = ()=>{
      const data = {productId :params.productId , size:params.selectedSize.name}
      dispatch(addItemToCart(data));
      console.log("data to cart is :",data);
      navigate('/cart')
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 px-4 gap-y-10 pt-10">
          ...
          <div className=" text-left py-1 lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2">
              <h1 className="text-lg lg:text-xl font:semibold tracking-tight text-gray-900 sm:text-3xl">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6">
                ...
                <p className="text-green-700 font-semibold">{products.product?.discountPresent}</p>
              </div>
              {/* Reviews */}
              <div className="mt-6">
